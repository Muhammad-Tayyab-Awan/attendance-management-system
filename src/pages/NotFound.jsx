...
const NotFound = () => {
  useEffect(() => {
    document.title = "AMS - Oops! Page Not Found";
  }, []);
    
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-blue-200 p-4 selection:bg-[#111827] selection:text-white dark:selection:bg-yellow-500 dark:selection:text-black">
